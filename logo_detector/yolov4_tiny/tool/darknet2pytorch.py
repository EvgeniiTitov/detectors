...
# from logo_detector.yolov4_tiny.tool.region_loss  import RegionLoss
# from logo_detector.yolov4_tiny.tool.yolo_layer import YoloLayer
# from logo_detector.yolov4_tiny.tool.config import *
# from logo_detector.yolov4_tiny.tool.torch_utils import get_region_boxes
import torch
        ...
        for block in blocks:
            if block['type'] == 'net':
                ...
                if activation == 'leaky':
                    ...
                    print("Convolution haven't activated {}".format(activation))
