...
import numpy as np
from yolov4_tiny.tool.region_loss import RegionLoss
from yolov4_tiny.tool.yolo_layer import YoloLayer
from yolov4_tiny.tool.config import *
from yolov4_tiny.tool.torch_utils import *
...
class Darknet(nn.Module):
    def __init__(self, cfgfile, inference=False):
        ...
        print(f"\nNet's resolution h: {self.height}, w: {self.width}")
